...
func TestBasic(t *testing.T) {
	...
	//grading: grep this line in the output
	fmt.Printf("JejjEOkcQT...TestBasicPassed...hdmDJlqpn3\n")
}
...
func TestOneFailure(t *testing.T) {
	...
	//grading: grep this line in the output
	fmt.Printf("EesIBVG3Rl...OneFailurePassed...AtTkChNYgK\n")
}
...
func TestManyFailures(t *testing.T) {
	...
	//grading: grep this line in the output
	fmt.Printf("KaC0KFyCvW...ManyFailuresPassed...S9g2A1YfYk\n")
}
